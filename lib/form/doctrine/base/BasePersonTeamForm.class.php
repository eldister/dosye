...
/**
 * PersonTeam form base class.
 *
 * @method PersonTeam getObject() Returns the current form's model object
 *
 * @package    dosye
 * @subpackage form
 ...
 */
abstract class BasePersonTeamForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('person_team[%s]');
