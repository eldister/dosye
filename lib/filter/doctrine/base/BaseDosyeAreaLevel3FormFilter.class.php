...
/**
 * DosyeAreaLevel3 filter form base class.
 *
 * @package    dosye
 * @subpackage filter
 ...
 */
abstract class BaseDosyeAreaLevel3FormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dosye_area_level3_filters[%s]');
