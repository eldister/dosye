...
/**
 * AreaLevel2 filter form base class.
 *
 * @package    dosye
 * @subpackage filter
 ...
 */
abstract class BaseAreaLevel2FormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('area_level2_filters[%s]');
