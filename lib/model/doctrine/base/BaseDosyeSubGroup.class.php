 ...
 * @property DosyeGroup $SuperGroup
 * @property DosyeGroup $SubGroup
 * 
 * @method integer       getSupergroupId()  Returns the current record's "supergroup_id" value
 * @method integer       getSubgroupId()    Returns the current record's "subgroup_id" value
 * @method DosyeGroup    getSuperGroup()    Returns the current record's "SuperGroup" value
 * @method DosyeGroup    getSubGroup()      Returns the current record's "SubGroup" value
 * @method DosyeSubGroup setSupergroupId()  Sets the current record's "supergroup_id" value
 * @method DosyeSubGroup setSubgroupId()    Sets the current record's "subgroup_id" value
 * @method DosyeSubGroup setSuperGroup()    Sets the current record's "SuperGroup" value
...
abstract class BaseDosyeSubGroup extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('supergroup_id', 'integer', null, array(
             'type' => 'integer',
             'primary' => true,
             ));
        ...
        $this->check('supergroup_id <> subgroup_id');
    }

    public function setUp()
    {
        parent::setUp();
        $this->hasOne('DosyeGroup as SuperGroup', array(
             'local' => 'supergroup_id',
             'foreign' => 'id'));
