...
CREATE TABLE person_team (person_id BIGINT, team_id BIGINT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, created_by BIGINT, updated_by BIGINT, INDEX created_by_idx (created_by), INDEX updated_by_idx (updated_by), PRIMARY KEY(person_id, team_id)) ENGINE = INNODB;
CREATE TABLE sub_team (superteam_id BIGINT, subteam_id BIGINT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, created_by BIGINT, updated_by BIGINT, INDEX created_by_idx (created_by), INDEX updated_by_idx (updated_by), PRIMARY KEY(superteam_id, subteam_id)) ENGINE = INNODB;
CREATE TABLE team (id BIGINT AUTO_INCREMENT, name VARCHAR(100) NOT NULL, photo_image_id BIGINT, description VARCHAR(255) NOT NULL, due_date DATE, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, created_by BIGINT, updated_by BIGINT, INDEX photo_image_id_idx (photo_image_id), INDEX created_by_idx (created_by), INDEX updated_by_idx (updated_by), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE team_file (team_id BIGINT, file_id BIGINT, visible TINYINT(1) DEFAULT '1' NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, created_by BIGINT, updated_by BIGINT, INDEX created_by_idx (created_by), INDEX updated_by_idx (updated_by), PRIMARY KEY(team_id, file_id)) ENGINE = INNODB;
...
ALTER TABLE person_team ADD CONSTRAINT person_team_updated_by_sf_guard_user_id FOREIGN KEY (updated_by) REFERENCES sf_guard_user(id);
ALTER TABLE person_team ADD CONSTRAINT person_team_team_id_team_id FOREIGN KEY (team_id) REFERENCES team(id);
ALTER TABLE person_team ADD CONSTRAINT person_team_person_id_person_id FOREIGN KEY (person_id) REFERENCES person(id);
ALTER TABLE person_team ADD CONSTRAINT person_team_created_by_sf_guard_user_id FOREIGN KEY (created_by) REFERENCES sf_guard_user(id);
ALTER TABLE sub_team ADD CONSTRAINT sub_team_updated_by_sf_guard_user_id FOREIGN KEY (updated_by) REFERENCES sf_guard_user(id);
ALTER TABLE sub_team ADD CONSTRAINT sub_team_superteam_id_team_id FOREIGN KEY (superteam_id) REFERENCES team(id);
ALTER TABLE sub_team ADD CONSTRAINT sub_team_subteam_id_team_id FOREIGN KEY (subteam_id) REFERENCES team(id);
ALTER TABLE sub_team ADD CONSTRAINT sub_team_created_by_sf_guard_user_id FOREIGN KEY (created_by) REFERENCES sf_guard_user(id);
ALTER TABLE team ADD CONSTRAINT team_updated_by_sf_guard_user_id FOREIGN KEY (updated_by) REFERENCES sf_guard_user(id);
ALTER TABLE team ADD CONSTRAINT team_photo_image_id_file_id FOREIGN KEY (photo_image_id) REFERENCES file(id);
ALTER TABLE team ADD CONSTRAINT team_created_by_sf_guard_user_id FOREIGN KEY (created_by) REFERENCES sf_guard_user(id);
ALTER TABLE team_file ADD CONSTRAINT team_file_updated_by_sf_guard_user_id FOREIGN KEY (updated_by) REFERENCES sf_guard_user(id);
ALTER TABLE team_file ADD CONSTRAINT team_file_team_id_team_id FOREIGN KEY (team_id) REFERENCES team(id);
ALTER TABLE team_file ADD CONSTRAINT team_file_file_id_file_id FOREIGN KEY (file_id) REFERENCES file(id);
ALTER TABLE team_file ADD CONSTRAINT team_file_created_by_sf_guard_user_id FOREIGN KEY (created_by) REFERENCES sf_guard_user(id);
