...
/**
 * DosyeAreaLevel2 form base class.
 *
 * @method DosyeAreaLevel2 getObject() Returns the current form's model object
 *
 * @package    dosye
 * @subpackage form
 ...
 */
abstract class BaseDosyeAreaLevel2Form extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dosye_area_level2[%s]');
