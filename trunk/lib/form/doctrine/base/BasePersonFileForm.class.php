...
/**
 * PersonFile form base class.
 *
 * @method PersonFile getObject() Returns the current form's model object
 *
 * @package    dosye
 * @subpackage form
 ...
 */
abstract class BasePersonFileForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('person_file[%s]');
