...
abstract class BaseMemberForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'marital_status_id'    => new sfValidatorInteger(array('required' => false)),
      ...
      'address_area1'        => new sfValidatorInteger(array('required' => false)),
      'address_area2'        => new sfValidatorInteger(array('required' => false)),
      'address_area3'        => new sfValidatorInteger(array('required' => false)),
      ...
      'educational_level'    => new sfValidatorInteger(array('required' => false)),
