...
/**
 * DosyeGroupPerson form base class.
 *
 * @method DosyeGroupPerson getObject() Returns the current form's model object
 *
 * @package    dosye
 * @subpackage form
 ...
 */
abstract class BaseDosyeGroupPersonForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dosye_group_person[%s]');
